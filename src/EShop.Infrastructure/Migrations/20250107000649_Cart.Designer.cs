...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Core.Entities.Catalog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Core.Entities.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Core.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("EShop.Core.Entities.CatalogItem", "CatalogItem")
                        .WithMany()
            ...
            modelBuilder.Entity("EShop.Core.Entities.Catalog", b =>
                {
                    b.HasOne("EShop.Core.Entities.Catalog", "ParentCatalog")
            ...
            modelBuilder.Entity("EShop.Core.Entities.CatalogItem", b =>
                {
                    b.HasOne("EShop.Core.Entities.Catalog", "Catalog")
                        .WithMany("Items")
